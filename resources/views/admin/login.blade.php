...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="index.html">
                <img src="{{ asset('admin_assets/pages/img/logo-big.png') }}" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            ...
            <form class="forget-form" action="http://keenthemes.com/preview/metronic/theme/admin_4/index.html" method="post">
            ...
            <form class="register-form" action="http://keenthemes.com/preview/metronic/theme/admin_4/index.html" method="post">
