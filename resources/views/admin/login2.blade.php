...
<html lang="en">
    ...
    <head>
        ...
        <link href="{{ asset('admin_assets/pages/css/login-5.min.css') }}" rel="stylesheet" type="text/css" />
    ...
    <body class=" login">
        ...
        <div class="user-login-5">
            <div class="row bs-reset">
                <div class="col-md-6 login-container bs-reset">
                    <img class="login-logo login-6" src="{{ asset('admin_assets/pages/img/login/login-invert.png') }}" />
                ...
                <div class="col-md-6 bgImageDiv bs-reset">
                    <div class="login-bgs">
                        <img src="{{ asset('admin_assets/pages/img/login/bg1.jpg') }}" class="deleteable">
                    </div>
                </div>
            </div>
        </div>
        ...
        <script src="{{ asset('admin_assets/global/plugins/backstretch/jquery.backstretch.min.js') }}" type="text/javascript"></script>
        <!-- END PAGE LEVEL PLUGINS -->
        <!-- BEGIN THEME GLOBAL SCRIPTS -->
        <script src="{{ asset('admin_assets/global/scripts/app.min.js') }}" type="text/javascript"></script>
        <!-- END THEME GLOBAL SCRIPTS -->
        <!-- BEGIN PAGE LEVEL SCRIPTS -->
        <script src="{{ asset('admin_assets/pages/scripts/login-5.min.js') }}" type="text/javascript"></script>
        ...
        <script>
            $(document).ready(function()
            {
                ...
                var requiredHeight = $('.login-container').height();
                console.log(requiredHeight);
                $('.bgImageDiv').css('height',requiredHeight+"px");
            })
        </script>
